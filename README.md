...
Готовы итерации 0–1 и часть 2a: сервисы `booking` и `payments`, провайдер PayStub в виде заглушки, сквозной сценарий «бронь → оплата → подтверждение». Статус — в [плане](docs/roadmap.md).
